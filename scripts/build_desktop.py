    ...
    (release / "README.txt").write_text(
        "\n".join(
            [
                ...
                "8. Force browser UI: SENSORS_DCS_BROWSER=1",
                "9. Desktop window needs Microsoft Edge WebView2 Runtime",
                "10. Hardware: dynamixel-sdk + pyserial bundled (Gello)",
                "    Install FTDI/USB-serial driver; match baudrate (default 57600)",
                "11. RealSense: install Intel RealSense SDK / pyrealsense2 on target",
