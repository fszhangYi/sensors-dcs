...
def main(argv: list[str] | None = None) -> None:
    ...
    app = create_viz_app(
        ...
        pi05_connect=orch.pi05_connect,
        pi05_disconnect=orch.pi05_disconnect,
        pi05_status=orch.pi05_status,
        pi05_set_prompt=orch.pi05_set_prompt,
        pi05_step=orch.pi05_step,
        delta_pose_offset_status=orch.delta_pose_offset_status,
        delta_pose_offset_set=orch._api_set_delta_pose_offset,
        arm_home_status=orch.arm_home_status,
